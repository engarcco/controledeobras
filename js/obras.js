        ...
        const card = `
            <div class="bg-white p-5 rounded-xl border border-gray-200 shadow-sm">
                ...
                <div class="flex gap-2 mt-4">
                    ...
                    <button onclick="APP.duplicarObra('${o.firebaseId}')" class="px-3 bg-gray-100 rounded border" title="Duplicar"><i data-lucide="copy" class="w-4 h-4"></i></button>
                </div>
            </div>`;
...
export const duplicarObra = (id) => {
    ...
    showToast('Altere o nome e o tipo para concluir a cópia');
};
